...
import com.example.visioneh.gobang.ChessPanel;
...
public class ConnectedThread extends Thread {
    ...
    private ChessPanel mGameView;
    private boolean isMe = false;

    public ConnectedThread(BluetoothSocket socket, ChessPanel gameView, boolean isStart) {
        mSocket = socket;
        mGameView = gameView;
        isMe = isStart;
    }
